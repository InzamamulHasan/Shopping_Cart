...
function fetchCartProduct(){
    ...
    if(!cart){
        ...
        <div class="cart-element">
            <h1 style=" color:crimson; width: 100%; font-size:40px">Oops, No items in cart.</h1>
        </div>;`
        checkPrice.remove();
        heading.remove();
    }
        ...
        <div class="container" style="border: 1px solid grey; overflow:hidden;">
          ...
          <div class="info">
            ...
            <h5 class="px-3 pb-3">Rating: ${Math.floor(element.rating.rate)}</h5> 
            <i class="material-icons" style="color: rgb(189, 169, 43); font-size: 15px!important">star</i>
